...
echo	'
	...
	<div class="container" style="background-color:#272f39;">
				<div class="col-md-6 col-center">
					...
					<div class="btn-group">
					  	<button type="button" class="btn btn-primary" data-toggle="dropdown"> ANUNCIOS DE '.$_SESSION["usuario"].'<span class="caret"></span></button>
					</div>		
				</div>
		</div>
		<div class="container" style="background-color:#374a6e;">
				<div class="row">
					<div class="col-md-12">
						...
						<a href="../view/vista_add_anuncio.php">
	...
	<div class="container" style="background-color:#456ba4; color: #ffffff;">
		...
		$Controlador =new controlador(); 
		$Controlador->user_anuncio($_SESSION["usuario"]);
