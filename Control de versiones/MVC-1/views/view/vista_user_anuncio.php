    ...
    <body>
        <?php
            ...
            echo   '<div class="panel panel-success">
                        <div class="panel-heading"><IMG src="../../resources/images/arrows/arrow-right.png" width="30" height="30" data-toggle="collapse" data-target="#demo'.$n_reg.'">
                            <b>'.$dato["titulo"].'</b>'.'   ||<b>   Propietario : </b>'.$dato["nom"].' '.$dato["ape"].'<b> TLF : </b>'.$dato["tlf"].'</div>
                            <div class="row">
