		...
		<div class="container">
		    ...
		    <!--<?php //phpinfo(); ?>-->
		    	<div class="panel panel-success">
					...
					<form action="body-user-log.php" method="POST" enctype="multipart/form-data">
					...
					<?php
						/*
							if ( isset($_POST["tb_log_user"]) &&  isset($_POST["tb_log_passw"])) {

								if ( !empty($_POST["tb_log_user"]) && !empty($_POST["tb_log_passw"])) 
								{
									...
									echo'<script type="text/javascript"> alert("Bienvenido; '.$_POST["tb_log_user"].' ; '.$_POST["tb_log_passw"].'"); </script>';	
								}

								else{
									echo'<script type="text/javascript"> alert("Los campos se encuentran vacios. Rellénelos y vuelva a intentarlo."); </script>';	
								}
