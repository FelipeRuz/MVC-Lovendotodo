...
<?php
	include '../header.php';
	include '../../function/user-function/function-validate-adduser.php';
	include '../../function/control/bd-control-userlog.php';
?>
	</head>
		...
		<div class="container">
		    ...
		    <div class="row">
		    	<div class="panel panel-success">
					...
					<form action='../../function/control/bd-control-useradd.php' method="POST" enctype="multipart/form-data">
