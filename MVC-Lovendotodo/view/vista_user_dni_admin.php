...
echo '<bodystyle="background-color: #647e98; color: white; font-family: "Consolas";>';
            echo'   <div class="container" style="background-color:#272f39;">
                        <div class="col-md-6 col-center">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="dropdown">  PERFIL DEL ADMINISTRADOR; [ '.$_SESSION["usuario"].' ]<span class="caret"></span></button> 
...
echo              '<div class="container" style="background-color:#374a6e; color: #ffffff;"> 
        ...
        echo                    '</div>  
                    ...
                    <div class="row">
                        <div class="col-md-12 col-center">
                        <a href="view-admin-user-all.php">
                            <IMG src="../resources/arrows/arrow-recharge.png" width="80" height="80">
                            <b>Listar usuarios</b> 
                        </a>
                        </div>
                    </div>
                ...
                <div class="container" style="background-color:#374a6e; color: #ffffff;">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <a href="view-ad-log-admin.php"><IMG src="../resources/ad/ad-base.png" width="80" height="80">
                            <b> Todos los anuncios</b></a>
                        </div>
                    </div> 
                </div>
            </div>
