<?php
            ...
            {
                 echo '<b>'.$dato["titulo"].'</b>'.' ||<b> Código : '.$dato["cod_anuncio"].' ||<b>   Propietario : </b>'.$dato["nom"].' '.$dato["ape"].'<b> TLF : </b>'.$dato["tlf"].'<a href="view-elim.php?pro=<?php echo $aux['.$dato["cod_anuncio"].']?>"><IMG src="../resources/ad/ad-del.png" width="30" height="30"></a></div>';
            }   
            else
            {
                 echo '<b>'.$dato["titulo"].'</b>'.' ||<b> Código : '.$dato["cod_anuncio"].' ||<b>   Propietario : </b>'.$dato["nom"].' '.$dato["ape"].'<b> TLF : </b>'.$dato["tlf"];
            }
            ...
            echo                '<div class="row">
                                <div id="demo'.$n_reg.'" class="collapse">
                                    ...
                                    <div class="col-md-6">
                                        <div class="panel-body"><b>Imagen : </b> <span class="label label-primary"><img src='.$dato["img"].' width="75" height="75"></span></div> 
                                    </div>
                                </div>
                            </div>
                    </div>';
